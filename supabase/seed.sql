...
INSERT INTO fighters (id, name, status, nationality, date_of_birth) VALUES
  ('a100000000000000000000000000001a', 'Jon Jones',        'active',   'USA',            '1987-07-19'),
  ('a100000000000000000000000000002a', 'Ciryl Gane',       'active',   'France',         '1990-05-26'),
  ('a100000000000000000000000000003a', 'Stipe Miocic',     'retired',  'USA',            '1982-08-19'),
  ('a100000000000000000000000000004a', 'Alex Pereira',     'active',   'Brazil',         '1987-07-08'),
  ('a100000000000000000000000000005a', 'Jamahal Hill',     'active',   'USA',            '1991-07-01'),
  ('a100000000000000000000000000006a', 'Jiri Prochazka',   'active',   'Czech Republic', '1993-10-14'),
  ('a100000000000000000000000000007a', 'Jan Blachowicz',   'active',   'Poland',         '1983-02-24'),
  ('a100000000000000000000000000008a', 'Magomed Ankalaev', 'active',   'Russia',         '1992-06-02');
...
INSERT INTO elo_history (id, fighter_id, fight_id, weight_class, elo_before, elo_after, delta, date) VALUES
  -- UFC 282: Blachowicz vs Ankalaev (draw — tiny ELO shift toward Ankalaev)
  ('d100000000000000000000000000001d', 'a100000000000000000000000000007a', 'c100000000000000000000000000001c', 'light heavyweight', 1650, 1644, -6,  '2022-12-10'),
  ('d100000000000000000000000000002d', 'a100000000000000000000000000008a', 'c100000000000000000000000000001c', 'light heavyweight', 1520, 1526,  6,  '2022-12-10'),
  -- UFC 285: Jones vs Gane
  ('d100000000000000000000000000003d', 'a100000000000000000000000000001a', 'c100000000000000000000000000002c', 'heavyweight',       1800, 1811, 11,  '2023-03-04'),
  ('d100000000000000000000000000004d', 'a100000000000000000000000000002a', 'c100000000000000000000000000002c', 'heavyweight',       1680, 1669, -11, '2023-03-04'),
  -- UFC 300: Pereira vs Hill
  ('d100000000000000000000000000005d', 'a100000000000000000000000000004a', 'c100000000000000000000000000003c', 'light heavyweight', 1750, 1760, 10,  '2024-04-13'),
  ('d100000000000000000000000000006d', 'a100000000000000000000000000005a', 'c100000000000000000000000000003c', 'light heavyweight', 1620, 1610, -10, '2024-04-13');
