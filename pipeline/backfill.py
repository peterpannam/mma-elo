"""
One-time historical backfill — scrapes every UFC event ever recorded,
loads fighters/events/fights into Supabase, then calculates ELO history.

Run from the pipeline/ directory:
    python backfill.py

Expected duration: 2–4 hours (sequential scraping of ~700 events).
...
if __name__ == "__main__":
    ...
    log.info("Step 1/4: Scraping all events, fights, and fighters from UFCStats.com...")
    scraped = fetch(DATA_DIR, all_events=True)
    log.info(
